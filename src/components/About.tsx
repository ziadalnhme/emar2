    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="mb-8">
              <span className="text-custom-blue font-semibold text-lg mb-2 block">من نحن</span>
            ...
            <div className="grid sm:grid-cols-2 gap-6 mb-8">
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-custom-blue mb-3">رؤيتنا</h3>
                <p className="text-gray-600">
                  أن نكون الشركة الرائدة في مجال المقاولات العامة والكهرباء في المنطقة
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md">
                <h3 className="text-xl font-bold text-custom-blue mb-3">رسالتنا</h3>
                <p className="text-gray-600">
