...
import { ArrowRight, Award, Shield, CheckCircle, Star, FileText, Calendar, Building2 } from 'lucide-react';
...
const CertificatesPage = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative min-h-[60vh] flex items-center bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 overflow-hidden pt-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            <div className="mb-6">
              <Link 
                to="/" 
                className="inline-flex items-center space-x-2 rtl:space-x-reverse text-blue-200 hover:text-white transition-colors mb-4"
              >
              ...
              <h1 className="text-5xl lg:text-6xl font-bold leading-tight mb-6">
                الشهادات
                <span className="text-custom-yellow"> والاعتمادات</span>
              </h1>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          {/* Certificates Grid */}
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">شهاداتنا</h2>
